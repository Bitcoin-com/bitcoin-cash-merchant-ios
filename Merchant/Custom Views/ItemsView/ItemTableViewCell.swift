...
final class ItemTableViewCell: UITableViewCell {
  ...
  func setItem(_ item: Item) {
    ...
    updateDescriptionView(hasDescription: !item.description.isEmpty)
  }
  ...
  private func updateDescriptionView(hasDescription: Bool) {
    if hasDescription {
  ...
  private func setupIconImageView() {
    ...
    NSLayoutConstraint.activate([
      ...
      iconImageView.leadingAnchor.constraint(
        equalTo: contentView.leadingAnchor, constant: Constants.ICON_MARGIN),
  ...
  private func setupLabelsStackView() {
    ...
    NSLayoutConstraint.activate([
      ...
      labelsStackView.leadingAnchor.constraint(
        equalTo: iconImageView.trailingAnchor, constant: Constants.TITLE_LABEL_MARGIN),
      labelsStackView.trailingAnchor.constraint(
        equalTo: contentView.trailingAnchor, constant: -Constants.TITLE_LABEL_MARGIN),
    ])
  }
