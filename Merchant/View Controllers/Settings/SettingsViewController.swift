...
final class SettingsViewController: UIViewController {
  ...
  // MARK: - Properties
  private let topOverlayView = GradientView(colors: [
    .white, .white, UIColor.white.withAlphaComponent(0),
  ])
  ...
  private func setupWalletAdView() {
    ...
    let tapGestureRecognizer = UITapGestureRecognizer(
      target: self, action: #selector(walletAdViewTapped))
    ...
    NSLayoutConstraint.activate([
      ...
      logoImageView.topAnchor.constraint(
        equalTo: walletAdView.topAnchor, constant: Constants.LOGO_TOP_MARGIN),
  ...
  private func setupLocalBitcoinCashAdView() {
    ...
    // Tap Gesture.
    let tapGestureRecognizer = UITapGestureRecognizer(
      target: self, action: #selector(localBitcoinCashAdViewTapped))
    ...
    NSLayoutConstraint.activate([
      ...
      logoImageView.topAnchor.constraint(
        equalTo: localBitcoinCashAdView.topAnchor, constant: Constants.LOGO_TOP_MARGIN),
      logoImageView.widthAnchor.constraint(equalToConstant: Constants.LOGO_WIDTH),
      logoImageView.heightAnchor.constraint(equalToConstant: Constants.LOGO_HEIGHT),
    ])
  ...
  private func updateMerchantName() {
    let alertController = UIAlertController(
      title: UserItem.merchantName.title, message: nil, preferredStyle: .alert)
  ...
  private func showAddDestionationAddressAlert() {
    let alertController = UIAlertController(
      title: Localized.addDestinationAddress, message: Localized.destinationAddressExplanation,
  ...
  private func showMultiterminalAlert() {
    let alertController = UIAlertController(
      title: Localized.enableMultiterminal, message: Localized.multiterminalExplanation,
      preferredStyle: .alert)
  ...
  private func showWarningAboutMissingBCHAddress() {
    let alertController = UIAlertController(
      title: Localized.paymentAddress, message: Localized.youMustProvideBCHAddress,
      preferredStyle: .alert)
...
extension SettingsViewController: ScannerViewControllerDelegate {
  ...
  func scannerViewController(
    _ viewController: ScannerViewController, didScanStringValue stringValue: String
  ) {
    viewController.dismiss(animated: true) { [weak self] in
      guard let self = self else { return }
...
extension SettingsViewController: CurrenciesViewControllerDelegate {
  ...
  func currenciesViewController(
    _ viewController: CurrenciesViewController, didPickCurrency currency: CountryCurrency
  ) {
    viewController.dismiss(animated: true) { [weak self] in
...
private struct Constants {
  ...
  static let LABEL_WIDTH: CGFloat =
    UIScreen.main.bounds.size.width / 2 - Constants.LOGO_LEADING_MARGIN
    - Constants.ITEMS_VIEW_MARGIN
  static let SCROLL_VIEW_WIDTH: CGFloat =
    UIScreen.main.bounds.size.width - 2 * AppConstants.GENERAL_MARGIN
}
...
private struct Localized {
  ...
  static var addDestinationAddress: String {
    NSLocalizedString("options_add_payment_address", comment: "")
  }
  static var destinationAddressExplanation: String {
    NSLocalizedString("options_explain_payment_address", comment: "")
  }
  static var scan: String { NSLocalizedString("scan", comment: "") }
  static var paste: String { NSLocalizedString("paste", comment: "") }
  static var unrecognizedPublicKeyFormat: String {
    NSLocalizedString("unrecognized_xpub", comment: "")
  }
  static var changesHaveBeenSaved: String {
    NSLocalizedString("notify_changes_have_been_saved", comment: "")
  }
  static var paymentAddress: String { NSLocalizedString("options_payment_address", comment: "") }
  static var youMustProvideBCHAddress: String {
    NSLocalizedString("obligatory_receiver", comment: "")
  }
  ...
  static var adContentBitcoinWallet: String {
    NSLocalizedString("ad_content_bitcoincom_wallet", comment: "")
  }
  static var adContentLocalBitcoinCash: String {
    NSLocalizedString("ad_content_local_bitcoin_cash", comment: "")
  }
  static var adContentBitcoinExchange: String {
    NSLocalizedString("ad_content_bitcoincom_exchange", comment: "")
  }
  static var enableMultiterminal: String {
    NSLocalizedString("options_multi_terminal", comment: "")
  }
  static var multiterminalExplanation: String {
    NSLocalizedString("options_explain_multiterminal", comment: "")
  }
